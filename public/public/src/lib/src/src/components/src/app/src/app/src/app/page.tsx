        ...
        {selected ? (
          <div>
            ...
            {streams.length ? (
              ...
              <div style={{ border:'1px solid #eee', borderRadius:12, padding:12 }}>Nenhum stream configurado.</div>
            )}
          </div>
        ) : (
          <div style={{ border:'1px solid #eee', borderRadius:12, padding:12 }}>Selecione uma estação à esquerda.</div>
        )}
      </div>
    </div>
  );
