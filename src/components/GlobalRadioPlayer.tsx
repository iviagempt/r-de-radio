...
export default function GlobalRadioPlayer() {
  ...
  // cria um único <audio> para a barra
  useEffect(() => {
    const el = new Audio();
    el.preload = "auto";
    ...
    // função global chamada pelos cards
  ...
  }, []); // não recriar o <audio> em mudanças de volume

  // aplicar volume quando mudar
  useEffect(() => {
  ...
  // Se quiser esconder o player até escolher uma rádio, descomente:
  ...
  return (
    ...
    >
      {/* Esquerda: info da estação (sem avatar nem placeholder) */}
